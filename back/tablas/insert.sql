...
values ('Sombrilla Playa Playera', 150 , 'Sombrilla playera de excelente calidad, IDEAL para tus vacaciones.', 12,'perfecto estado', 
...
('Carpa Camping Ottawa', 160 , 'Modelo: CNG 417 Ottawa IV, IDEAL para tus vacaciones.', 2,'perfecto estado', 
'https://http2.mlstatic.com/D_NQ_NP_608040-MLA48923827009_012022-O.jpg',2,'rentalstoreapp@gmail.com');
insert into producto (nombre_producto, precio, descripcion_producto, cantidad, estado,urlfoto,categoria, cliente) values 
('Paleta de pádel', 160 , 'Esta paleta de pádel compuesta por soft eva te permitirá conseguir una mayor estabilidad, duplicando la capacidad de respuesta en todo tipo de golpes.', 12,'perfecto estado', 
'https://http2.mlstatic.com/D_NQ_NP_812253-MLA48995446364_022022-O.jpg',3,'rentalstoreapp@gmail.com');
insert into producto (nombre_producto, precio, descripcion_producto, cantidad, estado, urlfoto, categoria, cliente) values 
('Taladro percutor inalámbrico', 160 , 'Con el taladro eléctrico Lüsqtoff ATL18-8B podrás realizar múltiples tareas en diversas superficies de un modo práctico y sencillo.', 12,'perfecto estado', 
...
insert into valoracion (valoracion, fecha, comentario,cliente,producto) 
values (5, '2023-05-22', 'Buen producto', 'rentalstoreapp@gmail.com', 3)
...
-- Actualizar stock luego de devolver alquiler
...
-- buscar bien como funcionan los inner join, left join y demás

select alquiler.id_alquiler, alquiler.fecha_inicio_alquiler as fecha_ini, alquiler.fecha_fin_alquiler as fecha_fin, cliente.email, cliente.telefono, cliente.direccion 
from alquiler
...
Group by alquiler.id_alquiler, fecha_ini, fecha_fin, cliente.email, cliente.telefono, cliente.direccion 
